...
export default function SinglePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const fetchVisitDataRef = useRef<any>(null);
  const fetchActiveDataRef = useRef<any>(null);
  const fetchCallDataRef = useRef<any>(null);
  const fetchSkippedDataRef = useRef<any>(null);
  ...
  useEffect(() => {
    const handleSettingUpdate = async (data?: any) => {
